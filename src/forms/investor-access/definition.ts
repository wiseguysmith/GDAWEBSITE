...
export const investorAccessFlow: FlowDefinition = {
  ...
  steps: [
    {
      ...
      fields: [
        ...
        { kind: "conditional-text", name: "investorTypeOther", label: c.steps.investorType.otherLabel, when: { field: "investorType", equals: "other" }, required: true },
      ],
    },
    {
      id: "jurisdiction",
