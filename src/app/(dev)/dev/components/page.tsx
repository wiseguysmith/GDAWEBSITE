...
export default function ComponentsPage() {
  ...
  const { home, shared, partnerCategories } = content;
  const facts = [
        ...
        <Section coordinate="§ DEV / Stage position" ticks>
          <Container>
            ...
            <div className="mt-(--head-gap) flex flex-col gap-8">
              <StagePosition stages={shared.stages} current={1} currentState={content.flowUi.position.fitPotential} />
              <StagePosition stages={shared.stages} current={3} currentState="In progress with partners" />
            </div>
          </Container>
        </Section>
          ...
          <Container width="narrow">
            ...
            <div className="mt-(--head-gap) flex flex-col gap-8">
              ...
              <Field id="dev-sel" label="Select">
                <Select id="dev-sel" options={content.fitCheck.steps.economics.options} placeholder="Select…" />
              </Field>
              ...
              <Checkbox id="dev-cb" label={content.legal.consent} />
              <InfoDrawer />
            </div>
          </Container>
        </Section>
